...
+(void)checkNewVersionAndCustomAlert:(NewVersionBlock)newVersion andNoNewVersionBlock:(NoNewVersionBlock)noNewVersion{
    
    [[XHVersion shardManger] checkNewVersionAndCustomAlert:newVersion andNoNewVersionBlock:noNewVersion];
}
...
-(void)checkNewVersionAndCustomAlert:(NewVersionBlock)newVersion andNoNewVersionBlock:(NoNewVersionBlock)noNewVersion{
    ...
    [self versionRequest:^(XHAppInfo *appInfo) {
        ...
        if(newVersion) newVersion(appInfo);
         ...
         if(noNewVersion) noNewVersion(appInfo);
    }];
}
-(void)versionRequest:(NewVersionBlock)newVersion andNoNewVersionBlock:(NoNewVersionBlock)noNewVersion{
